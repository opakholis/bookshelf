...
export default function Read({ book }) {
  ...
  return (
    <div className="h-[8.8rem] border-gray-100/90 dark:bg-primary-dark flex flex-row p-3 w-full bg-white border dark:border-gray-700 rounded-xl hover:-translate-y-1 transition-all duration-300 md:rounded-2xl lg:p-4">
